...
Run from the repository: lean CollatzSearchCerts.lean (pinned toolchain).
...
def main() -> None:
    ...
    if args.verify_lean:
        ...
        cmd = ["lean", f"+{toolchain}", str(lean_file)]
        print(f"Replaying all successful trajectories with {toolchain}...", flush=True)
